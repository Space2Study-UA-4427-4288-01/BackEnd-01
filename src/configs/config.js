...
const countrystatecityAccess = {
  COUNRTYSTATECITY_API_KEY: process.env.COUNRTYSTATECITY_API_KEY
}

module.exports = { config, gmailCredentials, superAdmin, azureAccess, countrystatecityAccess }
